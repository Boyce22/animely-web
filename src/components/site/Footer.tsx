      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4 px-6 lg:px-12 py-8">
        ...
        <div className="flex items-center gap-4">
          {socialLinks.map(({ label, d }) => (
            <a key={label} href="#" aria-label={label} className="text-muted-foreground hover:text-foreground/70 transition-colors duration-150">
