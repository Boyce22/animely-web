...
export const CONTENT_CARDS = {
  hero: {
    ...
    caption: "Isayama entregou uma obra-prima do comeÃ§o ao fim.",
    bigCaption: true,
    likes: 124,
    comments: 23,
    initialLiked: true,
  ...
  featuredTop: {
    ...
    series: "Frieren",
    caption: "Eu nunca pensei que magia poderia ser tÃ£o filosÃ³fica.",
    likes: 87,
    comments: 14,
  },
  featuredBottom: {
    ...
    caption: "Gege destruindo coraÃ§Ãµes desde 2018.",
    likes: 341,
    comments: 58,
  },
  squareLeft: {
    ...
    series: "Dandadan",
    caption: "Alien karate vs fantasma yokai â€” isso Ã© arte.",
    likes: 62,
    comments: 9,
  },
  squareCenter: {
  ...
  recommendationTopLeft: {
    ...
    caption: "A realidade do show business Ã© perturbadora.",
    likes: 178,
    comments: 31,
  },
  recommendationTopRight: {
    ...
    badge: { type: "score", text: "â˜… 8.8" },
    series: "Ping Pong",
    caption: "AnimaÃ§Ã£o mais honesta sobre talento e esforÃ§o que jÃ¡ vi.",
    likes: 92,
    comments: 12,
    initialLiked: true,
  },
  recommendationWide: {
    ...
    badge: { type: "score", text: "â˜… 9.0" },
    series: "Mushishi",
    caption: "O anime mais prÃ³ximo de um haiku que existe.",
    bigCaption: true,
    likes: 441,
    comments: 49,
    hasBookmark: true,
