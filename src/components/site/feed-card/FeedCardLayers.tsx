...
import type { FeedCardData, FeedMangaPanel } from "./feedCardTypes"
...
export function FeedCardBackground({ data, isManga }: { data: FeedCardData; isManga: boolean }) {
  if (isManga && data.panels) {
    return <MangaGrid layout={data.mangaLayout ?? "strip"} panels={data.panels} />
  }
...
export function FeedCardTextContent({ data }: { data: FeedCardData }) {
  return (
...
export function FeedCardEpisodeContent({ data }: { data: FeedCardData }) {
...
export function FeedCardSpoilerVeil({ data, onReveal }: { data: FeedCardData; onReveal: () => void }) {
  const { t } = useTranslation()
...
export function FeedCardBottomInfo({ data }: { data: FeedCardData }) {
  return (
...
export function FeedCardProgressBar() {
  return (
